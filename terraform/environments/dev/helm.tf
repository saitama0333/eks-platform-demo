# Keep Terraform-managed Helm releases together at the environment root.
# Applications managed by Argo CD are defined under platform/argocd/apps.
...
# Karpenter needs both EKS connection details and the sibling IAM/Pod Identity
# module's interruption queue, so install it at the root composition layer.
